...
numeric_path <- '../RawData/Bolivia_Schulmeyer/Bolivia_Schulmeyer_NumericValues.csv'
choice_path <- '../RawData/Bolivia_Schulmeyer/Bolivia_Schulmeyer_ChoiceValues.csv'
...
num_vars <- all_vars %>%
      ...
      remove_text('(^Q[0-9]+)|(TEXT$)|cultur|(^uni)') %>%
      remove(remove_vars)
